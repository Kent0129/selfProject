...
$params['mind2_id'] = $_SESSION['mind2_id'];
$params['mind3_id'] = $_SESSION['mind3_id'];
$params['content'] = $_SESSION['content'];
//コントローラーを起動
$mind4 = new MindMap4Controller();
//作成
$mind4->Create($user_id,$params);
$mind_3 = $_SESSION['mind3_id'];
?>
<!DOCTYPE html>
<html lang="ja">
<head>
...
<?php include('..//Common/_header.php');?>
  <main>
    <div class="contact_box border rounded mt-5 mx-auto text-center">
      ...
      <a class="btn btn-outline-info my-2 col-3" href="index.php?id=<?=h($mind_3)?>">戻る</a>
    </div>
  </main>
