...
$text =  $mind1->findById($mind1_id);
$content = $text['0']['content'];

$mind2 = new MindMap2Controller();
$result = $mind2->getMatch($user_id,$mind1_id);
      ...
      <div class="card-body">
        <div class="dropdown d-flex flex-row-reverse">
          ...
          <ul class="dropdown-menu text-right" aria-labelledby="dropdownMenuLink">
            <li><a class="dropdown-item" href="../MindMap3/form.php?id=<?=h($column['id']);?>"> 作成</a></li>
        ...
        <a href="../MindMap3/index.php?id=<?=h($column['id'])?>" class="btn btn-outline-info">ブランチへ</a>
      </div>
    </div>
  <?php endforeach;?>
  <?php else:?>
    <div class="card my-1">
      <div class="card-body">
        ...
        <a href="../MindMap2/form.php?id=<?=h($_GET['id'])?>" class="btn btn-outline-info stretched-link">作成する</a>
      </div>
    </div>
<?php endif;?>
  <a class="btn btn-outline-info my-3 col-4" href="../MindMap/index.php">戻る</a>
</div>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-ygbV9kiqUc6oa4msXn9868pTtWMgiQaeYH7/t7LECLbyPA2x65Kgf80OJFdroafW" crossorigin="anonymous"></script>
