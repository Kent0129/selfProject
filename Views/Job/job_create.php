...
$check = new Company();
$company = $check->findById($user_id);
...
<div class="col-lg-8 col-md-10 mt-5 mx-auto p-2 border rounded">
  <h1 class="h3 mt-2 mb-3 pb-1 font-weight-normal text-center border-bottom">求人作成</h1>
      <form class="w-100 mx-auto" action="" method="POST">
        ...
        <?php endforeach;?>  
          ...
          <input class="form-control" id="title" type="text" name="title" value="<?php if(!empty($submit['title'])){ echo h($submit['title']);};?>"  required autofocus/>
          <div class="row">
          ...
          <div class="col">
           ...
           <input class="form-control"  type="text" name="location" id="location" placeholder="渋谷区渋谷○丁目○-○" value="<?php if(!empty($submit['location'])){ echo $submit['location'];};?>"  required　autofocus/>
          </div>
          </div>
          ...
          <select class="form-select" name="sector_id" aria-label="Default select example" required>
            ...
            <div class="form-group my-1">
              ...
              <div class="form-check-inline form-check-inline">
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="checkbox" id="gridCheck1" name="educational" value="1"<?php if(!empty($submit['educational']) && $submit['educational'] == 1){ echo 'checked';}?>>
                  <label class="form-check-label" for="gridCheck1">
                    学歴不問
                  </label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="checkbox" id="gridCheck2" name="career" value="1"<?php if(!empty($submit['career']) && $submit['career'] == 1){ echo 'checked';}?>>
                  <label class="form-check-label" for="gridCheck2">
                    職歴不問
                  </label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="checkbox" id="gridCheck3" name="industry" value="1"<?php if(!empty($submit['industry']) && $submit['industry'] == 1){ echo 'checked';}?>>
                  <label class="form-check-label" for="gridCheck3">
                    業界未経験者歓迎
                  </label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="checkbox" id="gridCheck4" name="occupation" value="1"<?php if(!empty($submit['occupation']) && $submit['occupation'] == 1){ echo 'checked';}?>>
           ...
           <textarea class="body-form form-control" rows="3" name="body" id="body"  placeholder="2000文字まで入力できます。" required><?php if(!empty($submit['body']) && mb_ereg_match("^(\s|　)+$",$submit['body'])){echo h($submit['body']);}?></textarea>
