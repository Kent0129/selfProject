...
//作成
$mind3->Create($user_id,$params);
$mind2_id = $_SESSION['mind2_id'];

unset($_SESSION['id']);
unset($_SESSION['mind1_id']);
unset($_SESSION['mind2_id']);
...
<?php include('..//Common/_header.php');?>
  <main>
    <div class="contact_box border rounded mt-5 mx-auto text-center">
      ...
      <a class="btn btn-outline-info my-2 col-3" href="index.php?id=<?=h($mind2_id)?>">確認する</a>
    </div>
  </main>
